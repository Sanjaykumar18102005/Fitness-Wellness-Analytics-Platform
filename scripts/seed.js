...
async function seed() {
  ...
  for (const p of plans) {
    await query(
      `INSERT INTO membership_plans (name, price, duration_days, features) VALUES ($1, $2, $3, $4)`,
  ...
  const users = [
    ...
    { email: 'john.member@fitclub.com', password_hash: passwordHash, name: 'John Doe', role: 'member', membership_plan_id: 2, expiry: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000) }, // 5 days left -> triggers 7-day reminder
  ...
  for (const u of users) {
    await query(
      `INSERT INTO users (email, password_hash, name, role, membership_plan_id, membership_expiry) VALUES ($1, $2, $3, $4, $5, $6)`,
  ...
  await query(
    `INSERT INTO trainer_availability (trainer_id, start_time, end_time, is_booked) VALUES ($1, $2, $3, $4)`,
